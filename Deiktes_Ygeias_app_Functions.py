...
def two_cat_pie (val,val2,label1,label2):
    ...
    fig_two_cat_pie.add_trace(go.Pie(labels=['', ''],
                         values=[val, 100 - val],
                         hole=0.85,
                         title=dict(text=str(val)+"%"+"<br>"+str(label1),font_size=30, font=dict(color='rgb(113,209,145)',family="Arial")),
                         textinfo='none',
                         hoverinfo='none',
    ...
    fig_two_cat_pie.add_trace(go.Pie(labels=['', ''],
                         ...
                         hole=0.85,
                         title=dict(text=str(val2)+"%"+"<br>"+str(label2),font_size=30, font=dict(color='rgba(255,43,43,0.8)',family="Arial")),
                         textinfo='none',
                         hoverinfo="none",
