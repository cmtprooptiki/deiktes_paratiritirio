...
def two_cat_pie (val,val2,label1,label2):
    ...
    title_text2 = "<br><span style='font-size: 40px;color:rgba(255,43,43,0.8)'>" + str(val2) + "%</span>" + "<br><br><span style='font-size: 20px;'>" + str(label2) + "</span>"
...
def three_cat_pie (val,val2,val3,label1,label2,label3):
    title_text = "<br><span style='font-size: 35px;color:rgb(113,209,145)'>" + str(val) + "%</span>" + "<br><br><span style='font-size: 20px;'>" + str(label1) + "</span>"
    title_text2 = "<br><span style='font-size: 35px;color:rgba(255, 127, 14,0.7)'>" + str(val2) + "%</span>" + "<br><br><span style='font-size: 20px;'>" + str(label2) + "</span>"
    title_text3="<br><span style='font-size: 35px;color:rgba(255,43,43,0.8)'>" + str(val3) + "%</span>" + "<br><br><span style='font-size: 20px;'>" + str(label3) + "</span>"
...
def three_cat_pie_v2 (val,val2,val3,label1,label2,label3):
    title_text = "<br><span style='font-size: 35px;color:rgb(113,209,145)'>" + str(val) + "%</span>" + "<br><br><span style='font-size: 20px;'>" + str(label1) + "</span>"
    title_text2 = "<br><span style='font-size: 35px;color:rgba(255,43,43,0.8)'>" + str(val2) + "%</span>" + "<br><br><span style='font-size: 20px;'>" + str(label2) + "</span>"
    title_text3="<br><span style='font-size: 35px;color:rgba(255,43,43,0.8)'>" + str(val3) + "%</span>" + "<br><br><span style='font-size: 20px;'>" + str(label3) + "</span>"
    ...
    # Customazation of the fig
    fig_three_cat_pie_v2.update_layout(showlegend=False)
...
def four_cat_pie (val,val2,val3,val4,label1,label2,label3,label4):
    ...
    title_text2 = "<br><span style='font-size: 30px;color:rgba(255, 127, 14,0.7)'>" + str(val2) + "%</span>" + "<br><br><span style='font-size: 20px;'>" + str(label2) + "</span>"
    title_text3="<br><span style='font-size: 30px;color:rgba(255,43,43,0.6)'>" + str(val3) + "%</span>" + "<br><br><span style='font-size: 20px;'>" + str(label3) + "</span>"
    ...
    # Customazation of the fig
    fig_four_cat_pie.update_layout( showlegend=False)
...
def kpis_hist(value,min_value,max_value,bin_size):
    ...
    fig_kpis_hist = make_subplots(
      rows=2, cols=5,
      column_widths=[0.28,0.18,0.18,0.18,0.18],
...
def kpis_extra_hist(value):
    ...
    fig_extra_kpis_hist.add_trace(go.Indicator(
                  ...
                  align="left",
                  number={"font": {"size": 40,"color":color}},
                  title={"text":"Μ.Ο.","font":{"size":20,"color":"gray"},"align":"left"}
                  ),row=1,col=2)
    fig_extra_kpis_hist.add_trace(go.Indicator(
                  value=round(value.min(),1),
                  align="left",
