...
def main():
  ...
  df["gender"]=np.where(df["gender"].isna(), np.nan, df["gender"])
  #Ηλικιακές Κλάσεις
  ...
  with st.sidebar:
      ...
      if role=="admin":
        ...
        choose = option_menu(menu_title="Δείκτες Υγείας", options=["Επισκόπηση","Εργαστηριακοί","Βαρέων Μετάλων", "Λοιποί", "Εργασιακής Ικανοποίησης", "Εργατικών Ατυχημάτων-Απουσιασμού","Συγκρίσεις","Περιβάλλοντος"],
                            icons=['pie-chart','capsule','exclamation-octagon','clipboard-heart', 'emoji-smile', 'exclamation-triangle','bar-chart',"globe-americas"],
                            menu_icon="activity", default_index=0,
                             styles={
                            #         "container": {"padding": "5!important", "background-color": "#fafafa"},
                            #         "icon": {"color": "orange", "font-size": "30px"}, 
                                    "nav-link": {"font-size": "15x", "text-align": "left", "margin":"5px", "--hover-color": "#eee"},
                            #         "nav-link-selected": {"background-color": "#02ab21"},
                                  }
                            )
    ...
    with col1:
      with stylable_container(
        ...
        fig.add_trace(go.Indicator(
                      ...
                      title={"text":"Αρ.Εργαζομένων","font":{"size":22,"color":"gray"},"align":"center"}
                      ),row=1,col=1)
  ...
  ######################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes1")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes3")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes4")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes5")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes6")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes7")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes10")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes11")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes12")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_three_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes13")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Call of the function
          fig_four_cat_pie_v2=four_cat_pie_v2 (val,val2,val3,val4,"ΙΔΑΝΙΚΗ","ΣΧ. ΙΔΑΝ.","ΟΡ. ΥΨΗΛ.","ΥΨΗΛΗ")

          #Show the plot
          st.plotly_chart(fig_four_cat_pie_v2, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes14")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_three_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes15")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_four_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes16")
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes17")
        ...
        #Times gia sinartisi
          ...
          #Show the plot:
          st.plotly_chart(fig_kpis_hist, use_container_width=True,config={'displayModeBar': False},key="key")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes18a")
        ...
        #Times gia sinartisi
          ...
          #Show the plot:
          st.plotly_chart(fig_kpis_hist, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes18b")
    ###################################################################################################################################################################
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes21a")
        ...
        #Times gia sinartisi
          ...
          #Show the plot:
          st.plotly_chart(fig_kpis_hist, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes21b")
    ###################################################################################################################################################################
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes26")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Call of the function
          fig_two_cat_pie=two_cat_pie (val2,val,"ΑΡΝΗΤΙΚΟ","ΘΕΤΙΚΟ")

          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes27")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Call of the function
          fig_two_cat_pie=two_cat_pie (val,val2,"ΕΠΑΡΚΕΙΑ","ΑΡΝΗΤΙΚΟ")

          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes28")
    ...
    ###################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          #Times gia synartisi
          try:
            val=round((df_filtered["olika_anti_hbv_CAT"].value_counts().loc["ΑΡΝΗΤΙΚΟ"]/df_filtered["olika_anti_hbv_CAT"].value_counts().sum())*100,1)
          except KeyError:
            val=00.00
          
          try:
            val2=round((df_filtered["olika_anti_hbv_CAT"].value_counts().loc["ΘΕΤΙΚΟ"]/df_filtered["olika_anti_hbv_CAT"].value_counts().sum())*100,1)
          except KeyError:
            val2=00.00
          ...
          #Show the plot
          st.plotly_chart(fig_two_cat_pie, use_container_width=True,config={'displayModeBar': False},key="Ergastiriakes29")
    ...
    ################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Call of the function
          fig_four_cat_pie=four_cat_pie (val,val2,val3,val4,"ΜΗ ΚΑΠΝ.","ΗΠΙΟΣ","ΜΕΤΡΙΟΣ","ΒΑΡΥΣ")
  ...
  ##################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Call of the function
          fig_four_cat_pie=four_cat_pie (val,val2,val3,val4,"ΧΑΜΗΛΟΣ","ΜΕΤΡΙΟΣ","ΥΨΗΛΟΣ","ΠΟΛΥ ΥΨ.")
  ...
  #################################################################################################################################################################
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Call of the function
          fig_three_cat_pie=three_cat_pie (val,val2,val3,"ΙΚΑΝΟΠ.","ΑΜΦΙΘΥΜΙΑ","ΔΥΣΑΡΕΣΚ.")
      ...
      #with st.container(border=True):
        ...
        with col1:
          ...
          #Call of the function
          fig_four_cat_pie=four_cat_pie (val,val2,val3,val4,"ΑΠΟΥΣΙΑ","ΗΠΙΟ","ΜΕΤΡΙΟ","ΣΟΒΑΡΟ")
  ...
  #Εργατικά Ατυχήματα-Απουσιασμός - Section:
  elif choose== "Εργατικών Ατυχημάτων-Απουσιασμού":
    ...
    with stylable_container(
      ...
      st.title("Δείκτες Εργατικών Ατυχημάτων-Απουσιασμού")
    if (df_filtered["id_ergazomenou"].nunique()<privacy_limit):
      st.warning(warning_message,icon="⚠️")
    else:
      #dynamic_filters.display_df()
      ...
      with col1:
        ...
        key="Ergatika1",
          ...
          fig=go.Figure(go.Indicator(
                        ...
                        align="center",
                        number={"font": {"size": 40,"color":"#379683"}},
                        title={"text":"Δείκτης συχνότητας<br>εργατικών ατυχημάτων<br>(ΔΣ):","font":{"size":18,"color":"gray"},"align":"center"}
                        ))
          fig.update_layout(paper_bgcolor='rgba(0,0,0,0)',plot_bgcolor='white')
          st.plotly_chart(fig, use_container_width=True,config={'displayModeBar': False})
      with col2:
        ...
        key="Ergatika2",
          ...
          fig=go.Figure(go.Indicator(
                        ...
                        align="center",
                        number={"font": {"size": 40,"color":"#379683"}},
                        title={"text":"Δείκτης επίπτωσης<br>εργατικών ατυχημάτων<br>(ΔΕ):","font":{"size":18,"color":"gray"},"align":"center"}
                        ))
          fig.update_layout(paper_bgcolor='rgba(0,0,0,0)',plot_bgcolor='white')
          st.plotly_chart(fig, use_container_width=True,config={'displayModeBar': False})
      with col3:
        ...
        key="Ergatika3",
          ...
          fig=go.Figure(go.Indicator(
                        ...
                        align="center",
                        number={"font": {"size": 40,"color":"#379683"}},
                        title={"text":"Δείκτης σοβαρότητας<br>εργατικών ατυχημάτων<br>(ΔΣΟ):","font":{"size":18,"color":"gray"},"align":"center"}
                        ))
          fig.update_layout(paper_bgcolor='rgba(0,0,0,0)',plot_bgcolor='white')
          st.plotly_chart(fig, use_container_width=True,config={'displayModeBar': False})
      ...
      with stylable_container(
        ...
        #with st.container(border=True):
          ...
          with col1:
            ...
            #Call of the function
            fig_four_cat_pie=four_cat_pie (val,val2,val3,val4,"ΤΥΠΙΚO<br>ΣΚΟΡ","ΟΡΙΟ<br>ΑΝΗΣΥΧ.","ΑΝΗΣΥΧΙΑ","ΣΟΒΑΡΗ<br>ΑΝΗΣΥΧ.")
  ...
  if choose == "Περιβάλλοντος":
    ...
    url = 'https://backend.paratiritirio-edsna.gr:5000/buildingmetrics-public?api_key=37ca1953-2a98-4623-8a51-99729ca432da'
