...
def main():
  ...
  if choose == "Περιβάλλοντος":
    ...
    #         """,
    # ):
    response = json.loads(requests.get("https://backend.paratiritirio-edsna.gr:5000/buildingmetrics-public?api_key=37ca1953-2a98-4623-8a51-99729ca432da").text,verify=False)
